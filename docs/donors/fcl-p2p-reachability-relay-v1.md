...
| --- | --- | --- | --- | --- |
| AutoNAT v1 | `autonat-v1.md` | go-libp2p AutoNAT service smoke and Protocol Buffers registration tests | Protocol id, deterministic Protocol Buffers codec, inbound dial request handling, outbound probe through `/libp2p/autonat/1.0.0` | Supported subset: v1 dial probe over known peer |
