...
| [iterations/fcl-secret-provider-v1.md](iterations/fcl-secret-provider-v1.md) | Planned local secret provider plugin: source loading, redaction, purpose-gated crypto operations and donor baseline. |
