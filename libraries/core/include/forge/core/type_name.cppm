...
export module forge.core.type_name;
...
template <> struct get_typename<__int128> {
   static const char* name() {
      return "int128_t";
   }
};
template <> struct get_typename<unsigned __int128> {
   static const char* name() {
      return "uint128_t";
   }
};
...
template <> struct get_typename<std::string> {
   static const char* name() {
      return "string";
   }
};
