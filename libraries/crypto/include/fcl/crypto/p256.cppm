...
class public_key {
 public:
   ...
   bool valid() const;
   public_key mult(const fcl::crypto::sha256& offset);
   public_key add(const fcl::crypto::sha256& offset) const;
...
class private_key {
 public:
   ...
   signature sign_digest(const fcl::crypto::sha256& digest) const {
      return sign(digest);
   }
   compact_signature sign_compact(const fcl::crypto::sha256& digest) const;
   bool verify(const fcl::crypto::sha256& digest, const signature& sig);
   bool verify_digest(const fcl::crypto::sha256& digest, const signature& sig) {
