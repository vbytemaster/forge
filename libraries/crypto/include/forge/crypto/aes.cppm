...
export module forge.crypto.aes;

export import forge.exceptions;
import forge.crypto.types;

export namespace forge::crypto::aes::exceptions {
...
FORGE_DECLARE_EXCEPTION_CATEGORY(code, "forge.crypto.aes")
...
} // namespace forge::crypto::aes::exceptions
