...
export module forge.crypto.p256;
...
export namespace forge::crypto::p256 {
...
FORGE_DECLARE_EXCEPTION_CATEGORY(code, "forge.crypto.p256")
...
public_key_data recover_public_key_data(const compact_signature& c, const forge::crypto::sha256& digest,
...
class public_key {
 public:
   ...
   bool valid() const;
   public_key mult(const forge::crypto::sha256& offset);
   public_key add(const forge::crypto::sha256& offset) const;
...
class private_key {
 public:
   ...
   signature sign_digest(const forge::crypto::sha256& digest) const {
      return sign(digest);
   }
   compact_signature sign_compact(const forge::crypto::sha256& digest) const;
   bool verify(const forge::crypto::sha256& digest, const signature& sig);
   bool verify_digest(const forge::crypto::sha256& digest, const signature& sig) {
