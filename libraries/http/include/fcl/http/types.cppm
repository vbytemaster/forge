...
class request {
 public:
   request();
   request(fcl::http::method method_value, std::string target_value, unsigned version_value);
   ~request();
   ...
   [[nodiscard]] fcl::http::method method() const noexcept;
   void method(fcl::http::method value) noexcept;
...
class endpoint_request {
 public:
   ...
   [[nodiscard]] const fcl::http::request& request() const noexcept;
   [[nodiscard]] fcl::http::response& response() noexcept;
   [[nodiscard]] const fcl::http::response& response() const noexcept;
...
struct endpoint_state_access {
   [[nodiscard]] static std::shared_ptr<endpoint_state> make(fcl::http::request request_value,
                                                             fcl::http::response response_value);
   static void attach(endpoint_request& target, std::shared_ptr<endpoint_state> state);
   [[nodiscard]] static fcl::http::response& response(std::shared_ptr<endpoint_state>& state) noexcept;
   [[nodiscard]] static const fcl::http::response& response(const std::shared_ptr<endpoint_state>& state) noexcept;
};
