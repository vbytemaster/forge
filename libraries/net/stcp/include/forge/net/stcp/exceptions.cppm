...
export module forge.net.stcp.exceptions;

export import forge.exceptions;

export namespace forge::net::stcp::exceptions {
...
[[nodiscard]] inline std::optional<code> code_of(const forge::exceptions::base& value) noexcept {
   ...
   if (!actual || std::string_view{actual.category().name()} != "forge.net.stcp") {
      return std::nullopt;
   }
...
} // namespace forge::net::stcp::exceptions
