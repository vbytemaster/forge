...
export module fcl.p2p.diagnostics;
...
BOOST_DESCRIBE_STRUCT(fcl::p2p::diagnostics::options, (),
                      (max_peers, max_sessions, max_endpoints_per_peer, max_protocols_per_peer,
                       max_relay_reservations_per_peer))
BOOST_DESCRIBE_STRUCT(fcl::p2p::diagnostics::metrics_snapshot, (),
...
BOOST_DESCRIBE_STRUCT(fcl::p2p::diagnostics::network_state, (), (local_peer, local_endpoints, stopped))
BOOST_DESCRIBE_STRUCT(fcl::p2p::diagnostics::endpoint_record, (),
                      (endpoint, kind, relay_peer, successes, failures, last_latency, backoff_until, score))
BOOST_DESCRIBE_STRUCT(fcl::p2p::diagnostics::relay_reservation, (),
                      (relay, reservation_id, expires_at, endpoints, successes, failures, last_latency, score))
BOOST_DESCRIBE_STRUCT(fcl::p2p::diagnostics::peer, (),
                      (peer, capabilities, discovered_by, protocol_version, agent_version, protocols, endpoints,
                       ...
                       protected_peer))
BOOST_DESCRIBE_STRUCT(fcl::p2p::diagnostics::session, (),
                      (id, remote_peer, capabilities, path, relay_peer, direct_endpoint, remote_endpoint, direction,
                       age, idle, closed, protected_peer))
BOOST_DESCRIBE_STRUCT(fcl::p2p::diagnostics::connection_state, (), (active_sessions, protected_peers))
BOOST_DESCRIBE_STRUCT(fcl::p2p::diagnostics::snapshot, (),
