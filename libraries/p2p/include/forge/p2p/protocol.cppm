...
export module forge.p2p.protocol;
...
namespace builtins {
inline const protocol_id echo{.value = "/forge/p2p/echo/1"};
...
inline const protocol_id peer_exchange{.value = "/forge/p2p/peer-exchange/1"};
