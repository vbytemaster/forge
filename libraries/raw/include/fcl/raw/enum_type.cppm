module;
#include <string>
export module fcl.raw.enum_type;
...
template <typename IntType, typename EnumType> class enum_type {
 public:
   ...
   operator std::string() const {
      return fcl::reflect::enum_to_string(value);
   }
...
inline void pack(Stream& s, const fcl::enum_type<IntType, EnumType>& tp) {
   fcl::raw::pack(s, static_cast<IntType>(tp));
}

template <typename Stream, typename IntType, typename EnumType>
inline void unpack(Stream& s, fcl::enum_type<IntType, EnumType>& tp) {
   IntType t;
   fcl::raw::unpack(s, t);
   tp = t;
}
