...
variant_object::variant_object(std::string key, variant val) : _key_value(std::make_shared<std::vector<entry>>()) {
   _key_value->emplace_back(entry(std::move(key), std::move(val)));
}

variant_object::variant_object(const variant_object& obj) : _key_value(obj._key_value) {
   assert(_key_value != nullptr);
}

variant_object::variant_object(variant_object&& obj) noexcept : _key_value(std::move(obj._key_value)) {
...
variant_object::variant_object(mutable_variant_object&& obj) : _key_value(std::move(obj._key_value)) {
   assert(_key_value != nullptr);
}
...
mutable_variant_object::mutable_variant_object(std::string key, variant val) : _key_value(new std::vector<entry>()) {
...
mutable_variant_object::mutable_variant_object(variant_object&& obj) : _key_value(new std::vector<entry>()) {
