...
using resource_limit = fcl::exception::coded_exception<code, code::resource_limit>;
...
[[nodiscard]] inline std::optional<code> code_of(const fcl::exception::base& value) noexcept {
   ...
   if (actual == fcl::exception::make_error_code(code::resource_limit)) {
      return code::resource_limit;
   }
   if (actual == fcl::exception::make_error_code(code::stream_reset)) {
