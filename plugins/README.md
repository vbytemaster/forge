...
HTTP server, a P2P node or a signing provider, and many application plugins need
to contribute behavior to it.
...
`fcl::plugins::p2p` and `fcl::plugins::http` are empty.
