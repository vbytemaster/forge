...
export module fcl.plugins.crypto.secrets.types;
...
struct config {
   ...
   std::uint64_t default_max_plaintext_bytes = fcl::plugins::crypto::secrets::default_max_plaintext_bytes;
   std::uint64_t default_max_ciphertext_bytes = fcl::plugins::crypto::secrets::default_max_ciphertext_bytes;
   std::uint64_t default_max_aad_bytes = fcl::plugins::crypto::secrets::default_max_aad_bytes;
   std::uint64_t encrypted_file_max_scrypt_n = fcl::plugins::crypto::secrets::default_encrypted_file_max_scrypt_n;
   std::uint64_t encrypted_file_max_scrypt_r = fcl::plugins::crypto::secrets::default_encrypted_file_max_scrypt_r;
   std::uint64_t encrypted_file_max_scrypt_p = fcl::plugins::crypto::secrets::default_encrypted_file_max_scrypt_p;
   std::uint64_t encrypted_file_max_scrypt_memory_bytes =
      fcl::plugins::crypto::secrets::default_encrypted_file_max_scrypt_memory_bytes;
};
...
export template <> struct fcl::schema::rules<fcl::plugins::crypto::secrets::secret_source> {
   [[nodiscard]] static fcl::schema::object_schema<fcl::plugins::crypto::secrets::secret_source> define() {
      auto schema = fcl::schema::object<fcl::plugins::crypto::secrets::secret_source>();
      schema.field<&fcl::plugins::crypto::secrets::secret_source::type>("type").description("Secret source type");
      schema.field<&fcl::plugins::crypto::secrets::secret_source::encoding>("encoding")
         .description("Encoding used by value and file sources");
      schema.field<&fcl::plugins::crypto::secrets::secret_source::value>("value")
         .secret()
         .description("Secret value delivered by FCL config sources");
      schema.field<&fcl::plugins::crypto::secrets::secret_source::path>("path")
         .description("Secret file or encrypted_file path");
      schema.field<&fcl::plugins::crypto::secrets::secret_source::passphrase_value>("passphrase-value")
         .secret()
         .description("Passphrase for encrypted_file source");
      schema.field<&fcl::plugins::crypto::secrets::secret_source::passphrase_file>("passphrase-file")
         .description("Path to passphrase file for encrypted_file source");
      return schema;
   }
};

export template <> struct fcl::schema::rules<fcl::plugins::crypto::secrets::secret_entry> {
   [[nodiscard]] static fcl::schema::object_schema<fcl::plugins::crypto::secrets::secret_entry> define() {
      auto schema = fcl::schema::object<fcl::plugins::crypto::secrets::secret_entry>();
      schema.field<&fcl::plugins::crypto::secrets::secret_entry::id>("id").required().non_empty();
      schema.field<&fcl::plugins::crypto::secrets::secret_entry::kind>("kind").description("Secret material kind");
      schema.field<&fcl::plugins::crypto::secrets::secret_entry::source>("source").required().secret();
      schema.field<&fcl::plugins::crypto::secrets::secret_entry::purposes>("purposes").min_items(1).each_non_empty();
      schema.field<&fcl::plugins::crypto::secrets::secret_entry::operations>("operations").min_items(1);
      schema.field<&fcl::plugins::crypto::secrets::secret_entry::allow_raw_export>("allow-raw-export")
         .default_value(false);
      schema.field<&fcl::plugins::crypto::secrets::secret_entry::max_plaintext_bytes>("max-plaintext-bytes")
         .range(0, fcl::plugins::crypto::secrets::aes_update_bytes_ceiling);
      schema.field<&fcl::plugins::crypto::secrets::secret_entry::max_ciphertext_bytes>("max-ciphertext-bytes")
         .range(0, fcl::plugins::crypto::secrets::aes_update_bytes_ceiling);
      schema.field<&fcl::plugins::crypto::secrets::secret_entry::max_aad_bytes>("max-aad-bytes")
         .range(0, fcl::plugins::crypto::secrets::aes_update_bytes_ceiling);
      return schema;
   }
};

export template <> struct fcl::schema::rules<fcl::plugins::crypto::secrets::config> {
   [[nodiscard]] static fcl::schema::object_schema<fcl::plugins::crypto::secrets::config> define() {
      auto schema = fcl::schema::object<fcl::plugins::crypto::secrets::config>();
      schema.field<&fcl::plugins::crypto::secrets::config::secrets>("secrets")
         .items<fcl::plugins::crypto::secrets::secret_entry>()
         .secret()
         .unique_by<&fcl::plugins::crypto::secrets::secret_entry::id>();
      schema.field<&fcl::plugins::crypto::secrets::config::default_max_plaintext_bytes>("default-max-plaintext-bytes")
         .default_value(fcl::plugins::crypto::secrets::default_max_plaintext_bytes)
         .range(1, fcl::plugins::crypto::secrets::aes_update_bytes_ceiling);
      schema.field<&fcl::plugins::crypto::secrets::config::default_max_ciphertext_bytes>("default-max-ciphertext-bytes")
         .default_value(fcl::plugins::crypto::secrets::default_max_ciphertext_bytes)
         .range(1, fcl::plugins::crypto::secrets::aes_update_bytes_ceiling);
      schema.field<&fcl::plugins::crypto::secrets::config::default_max_aad_bytes>("default-max-aad-bytes")
         .default_value(fcl::plugins::crypto::secrets::default_max_aad_bytes)
         .range(1, fcl::plugins::crypto::secrets::aes_update_bytes_ceiling);
      schema.field<&fcl::plugins::crypto::secrets::config::encrypted_file_max_scrypt_n>("encrypted-file-max-scrypt-n")
         .default_value(fcl::plugins::crypto::secrets::default_encrypted_file_max_scrypt_n)
         .range(1, 1ULL << 32);
      schema.field<&fcl::plugins::crypto::secrets::config::encrypted_file_max_scrypt_r>("encrypted-file-max-scrypt-r")
         .default_value(fcl::plugins::crypto::secrets::default_encrypted_file_max_scrypt_r)
         .range(1, 1ULL << 32);
      schema.field<&fcl::plugins::crypto::secrets::config::encrypted_file_max_scrypt_p>("encrypted-file-max-scrypt-p")
         .default_value(fcl::plugins::crypto::secrets::default_encrypted_file_max_scrypt_p)
         .range(1, 1ULL << 32);
      schema
         .field<&fcl::plugins::crypto::secrets::config::encrypted_file_max_scrypt_memory_bytes>(
            "encrypted-file-max-scrypt-memory-bytes")
         .default_value(fcl::plugins::crypto::secrets::default_encrypted_file_max_scrypt_memory_bytes)
         .range(1, 1ULL << 32);
      return schema;
   }
};
