...
export module fcl.plugins.crypto.signer.types;
...
export template <> struct fcl::schema::rules<fcl::plugins::crypto::signer::key> {
   [[nodiscard]] static fcl::schema::object_schema<fcl::plugins::crypto::signer::key> define() {
      auto schema = fcl::schema::object<fcl::plugins::crypto::signer::key>();
      schema.field<&fcl::plugins::crypto::signer::key::id>("id").required().non_empty();
      schema.field<&fcl::plugins::crypto::signer::key::private_key>("private-key")
         .required()
         .non_empty()
         .secret()
         .description("Private key material in one of the configured input profiles");
      schema.field<&fcl::plugins::crypto::signer::key::input_profile>("input-profile").default_value("fcl");
      schema.field<&fcl::plugins::crypto::signer::key::purposes>("purposes")
         .min_items(1)
         .each_non_empty()
...
export template <> struct fcl::schema::rules<fcl::plugins::crypto::signer::config> {
   [[nodiscard]] static fcl::schema::object_schema<fcl::plugins::crypto::signer::config> define() {
      auto schema = fcl::schema::object<fcl::plugins::crypto::signer::config>();
      schema.field<&fcl::plugins::crypto::signer::config::keys>("keys")
         .items<fcl::plugins::crypto::signer::key>()
         .secret()
         .unique_by<&fcl::plugins::crypto::signer::key::id>()
         .description("Local crypto signer key entries");
      schema.field<&fcl::plugins::crypto::signer::config::default_output_profile>("default-output-profile")
         .default_value("fcl")
