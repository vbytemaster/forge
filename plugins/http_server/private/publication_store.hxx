...
struct publication_snapshot {
   ...
   std::vector<std::pair<file_publication, publish_options>> files;
   std::vector<std::pair<upload_publication, publish_options>> uploads;
};

class publication_store {
 public:
   void publish(fcl::http::api_binding binding, publish_options options);
   void publish(file_publication publication, publish_options options);
   void publish(upload_publication publication, publish_options options);
 ...
 private:
   ...
   std::vector<std::pair<file_publication, publish_options>> files_;
   std::vector<std::pair<upload_publication, publish_options>> uploads_;
};
