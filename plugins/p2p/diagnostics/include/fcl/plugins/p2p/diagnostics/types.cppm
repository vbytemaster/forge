...
export module fcl.plugins.p2p.diagnostics.types;
...
export template <> struct fcl::schema::rules<fcl::plugins::p2p::diagnostics::config> {
   [[nodiscard]] static fcl::schema::object_schema<fcl::plugins::p2p::diagnostics::config> define() {
      auto schema = fcl::schema::object<fcl::plugins::p2p::diagnostics::config>();
      schema.field<&fcl::plugins::p2p::diagnostics::config::max_peers>("max-peers")
         .default_value(std::uint64_t{1'024})
         .range(1, 1'000'000);
      schema.field<&fcl::plugins::p2p::diagnostics::config::max_sessions>("max-sessions")
         .default_value(std::uint64_t{1'024})
         .range(1, 1'000'000);
      schema.field<&fcl::plugins::p2p::diagnostics::config::max_endpoints_per_peer>("max-endpoints-per-peer")
         .default_value(std::uint64_t{64})
         .range(1, 1'000'000);
      schema.field<&fcl::plugins::p2p::diagnostics::config::max_protocols_per_peer>("max-protocols-per-peer")
         .default_value(std::uint64_t{128})
         .range(1, 1'000'000);
      schema.field<&fcl::plugins::p2p::diagnostics::config::max_relay_reservations_per_peer>(
