...
export module fcl.plugins.p2p.node.types;
...
struct config {
   ...
   fcl::plugins::p2p::node::path_policy path_policy = fcl::plugins::p2p::node::path_policy::direct_preferred;
...
export template <> struct fcl::schema::rules<fcl::plugins::p2p::node::config> {
   [[nodiscard]] static fcl::schema::object_schema<fcl::plugins::p2p::node::config> define() {
      auto schema = fcl::schema::object<fcl::plugins::p2p::node::config>();
      schema.field<&fcl::plugins::p2p::node::config::listen>("listen")
         .default_value(std::vector<std::string>{})
         .description("Listen endpoints, for example /ip4/0.0.0.0/udp/9443/quic-v1 or /ip4/0.0.0.0/tcp/4001");
      schema.field<&fcl::plugins::p2p::node::config::bootstrap>("bootstrap")
         .default_value(std::vector<std::string>{})
         .description("Bootstrap peer endpoints as libp2p multiaddr text");
      schema.field<&fcl::plugins::p2p::node::config::advertised_endpoints>("advertised-endpoints")
         .default_value(std::vector<std::string>{})
         .description("Endpoints advertised to peers as libp2p multiaddr text");
      schema.field<&fcl::plugins::p2p::node::config::peer_id>("peer-id").default_value("");
      schema.field<&fcl::plugins::p2p::node::config::certificate_pem>("certificate-pem").default_value("");
      schema.field<&fcl::plugins::p2p::node::config::private_key_pem>("private-key-pem").default_value("").secret();
      schema.field<&fcl::plugins::p2p::node::config::api_codec>("api-codec").default_value("fcl.raw");
      schema.field<&fcl::plugins::p2p::node::config::api_deadline_ms>("api.deadline-ms")
         .default_value(std::uint64_t{0})
         .range(0, 86'400'000);
      schema.field<&fcl::plugins::p2p::node::config::api_max_frame_size>("api.max-frame-size")
         .default_value(std::uint64_t{16 * 1024 * 1024})
         .range(1, 1024 * 1024 * 1024);
      schema.field<&fcl::plugins::p2p::node::config::max_inflight_per_peer>("max-inflight-per-peer")
         .default_value(std::uint64_t{64})
         .range(1, 1'000'000);
      schema.field<&fcl::plugins::p2p::node::config::max_sessions>("max-sessions")
         .default_value(std::uint64_t{1024})
         .range(1, 1'000'000);
      schema.field<&fcl::plugins::p2p::node::config::max_protocol_handlers>("max-protocol-handlers")
         .default_value(std::uint64_t{1024})
         .range(1, 1'000'000);
      schema.field<&fcl::plugins::p2p::node::config::allow_insecure_test_mode>("allow-insecure-test-mode")
         .default_value(false)
         .description("Test-only mode for local development without deployment identity material");
      schema.field<&fcl::plugins::p2p::node::config::path_policy>("path.policy")
         .default_value("direct-preferred")
         .description("Default host path policy: direct-only, direct-preferred or relay-only");
      schema.field<&fcl::plugins::p2p::node::config::relay_trust>("relay.trust")
         .default_value("known-only")
         .description("Relay trust policy: known-only or public-allowed");
      schema.field<&fcl::plugins::p2p::node::config::relay_client_enabled>("relay.client-enabled")
         .default_value(true);
      schema.field<&fcl::plugins::p2p::node::config::relay_server_enabled>("relay.server-enabled")
         .default_value(false);
      schema.field<&fcl::plugins::p2p::node::config::relay_public_allowed>("relay.public-allowed")
         .default_value(false);
      schema.field<&fcl::plugins::p2p::node::config::relay_reservation_ttl_ms>("relay.reservation-ttl-ms")
         .default_value(std::uint64_t{60'000})
         .range(1, 86'400'000);
      schema.field<&fcl::plugins::p2p::node::config::relay_max_candidates>("relay.max-candidates")
