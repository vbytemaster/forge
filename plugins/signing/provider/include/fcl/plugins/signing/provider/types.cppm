...
export module fcl.plugins.signing.provider.types;
...
export template <> struct fcl::schema::rules<fcl::plugins::signing::provider::key> {
   [[nodiscard]] static fcl::schema::object_schema<fcl::plugins::signing::provider::key> define() {
      auto schema = fcl::schema::object<fcl::plugins::signing::provider::key>();
      schema.field<&fcl::plugins::signing::provider::key::id>("id").required().non_empty();
      schema.field<&fcl::plugins::signing::provider::key::private_key>("private-key")
         .required()
         .non_empty()
         .secret()
         .description("Private key material in one of the configured input profiles");
      schema.field<&fcl::plugins::signing::provider::key::input_profile>("input-profile").default_value("fcl");
      schema.field<&fcl::plugins::signing::provider::key::purposes>("purposes")
         .min_items(1)
         .each_non_empty()
...
export template <> struct fcl::schema::rules<fcl::plugins::signing::provider::config> {
   [[nodiscard]] static fcl::schema::object_schema<fcl::plugins::signing::provider::config> define() {
      auto schema = fcl::schema::object<fcl::plugins::signing::provider::config>();
      schema.field<&fcl::plugins::signing::provider::config::keys>("keys")
         .items<fcl::plugins::signing::provider::key>()
         .secret()
         .unique_by<&fcl::plugins::signing::provider::key::id>()
         .description("Local signature provider key entries");
      schema.field<&fcl::plugins::signing::provider::config::default_output_profile>("default-output-profile")
         .default_value("fcl")
