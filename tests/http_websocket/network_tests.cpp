...
struct delete_path_request : fcl::http::endpoint_request {
   std::string collection;
   std::string key;
};
...
class positional_query_append_api : public fcl::api::contract<positional_query_append_api> {
 public:
   virtual ~positional_query_append_api() = default;

   virtual boost::asio::awaitable<positional_http_response>
   read(std::string ref, fcl::http::query<std::uint32_t> limit) = 0;
};

class positional_plain_body_api : public fcl::api::contract<positional_plain_body_api> {
 public:
...
class positional_ambiguous_body_api : public fcl::api::contract<positional_ambiguous_body_api> {
 public:
...
class positional_checked_body_api : public fcl::api::contract<positional_checked_body_api> {
 public:
...
class object_api : public fcl::api::contract<object_api> {
 public:
   ...
   virtual boost::asio::awaitable<fcl::http::streaming_response> stream_object(object_get_request request) = 0;
...
class delete_path_api : public fcl::api::contract<delete_path_api> {
 public:
...
FCL_API(::fcl::http::test_api::positional_query_append_api, FCL_API_CONTRACT("http.positional.query-append", 1, 0),
        FCL_API_METHOD(read, ref, limit))

FCL_API(::fcl::http::test_api::positional_plain_body_api, FCL_API_CONTRACT("http.positional.plain-body", 1, 0),
        FCL_API_METHOD(write, ref, payload))

FCL_API(::fcl::http::test_api::positional_ambiguous_body_api,
        FCL_API_CONTRACT("http.positional.ambiguous-body", 1, 0),
        FCL_API_METHOD(write, ref, left, right))
...
FCL_API(::fcl::http::test_api::object_api, FCL_API_CONTRACT("object", 1, 0),
        ...
        FCL_API_METHOD_TYPED(stream_object, ::fcl::http::test_api::object_get_request,
...
template <> struct fcl::schema::rules<::fcl::http::test_api::search_request> {
   [[nodiscard]] static fcl::schema::object_schema<::fcl::http::test_api::search_request> define() {
      auto schema = fcl::schema::object<::fcl::http::test_api::search_request>();
      schema.field<&::fcl::http::test_api::search_request::term>("term").required().non_empty();
      schema.field<&::fcl::http::test_api::search_request::limit>("limit").required().range(1, 100);
      return schema;
   }
};
...
template <> struct fcl::schema::rules<::fcl::http::test_api::positional_ref_payload> {
   [[nodiscard]] static fcl::schema::object_schema<::fcl::http::test_api::positional_ref_payload> define() {
      auto schema = fcl::schema::object<::fcl::http::test_api::positional_ref_payload>();
      schema.field<&::fcl::http::test_api::positional_ref_payload::ref>("ref").required().non_empty();
      schema.field<&::fcl::http::test_api::positional_ref_payload::value>("value").required().non_empty();
      return schema;
   }
};
...
template <> struct fcl::schema::rules<::fcl::http::test_api::json_stream_request> {
   [[nodiscard]] static fcl::schema::object_schema<::fcl::http::test_api::json_stream_request> define() {
      ...
      schema.field<&::fcl::http::test_api::json_stream_request::id>("id").required().non_empty();
      schema.field<&::fcl::http::test_api::json_stream_request::value>("value").required().non_empty();
      return schema;
   }
};
...
FCL_HTTP_API(::fcl::http::test_api::positional_query_append_api,
             FCL_HTTP_GET(read, "/query/:ref"))

FCL_HTTP_API(::fcl::http::test_api::positional_plain_body_api,
             FCL_HTTP_POST(write, "/plain/:ref", created))

FCL_HTTP_API(::fcl::http::test_api::positional_ambiguous_body_api,
             FCL_HTTP_POST(write, "/ambiguous/:ref", created))
...
FCL_HTTP_API(::fcl::http::test_api::object_api,
             ...
             FCL_HTTP_GET(stream_object, "/objects/:collection/:key/stream", FCL_HTTP_RESPONSE_STREAM),
...
class positional_query_append_api_impl final : public positional_query_append_api {
 public:
   boost::asio::awaitable<positional_http_response>
   read(std::string ref, fcl::http::query<std::uint32_t> limit) override {
      const auto limit_text = limit.present ? std::to_string(limit.value) : std::string{"missing-limit"};
...
class object_api_impl final : public object_api {
 public:
   ...
   boost::asio::awaitable<fcl::http::streaming_response> stream_object(object_get_request request) override {
      auto file = std::make_shared<std::ifstream>(object_path(request.collection, request.key), std::ios::binary);
      co_return fcl::http::streaming_response::from_source(
         fcl::http::streaming_response_options{
            .content_type = "application/octet-stream",
            .body =
               [file]() mutable -> boost::asio::awaitable<std::optional<fcl::http::body_chunk>> {
...
class object_proxy_api_impl final : public object_api {
 public:
   explicit object_proxy_api_impl(fcl::api::handle<object_api> upstream) : upstream_{std::move(upstream)} {}
 ...
 private:
   fcl::api::handle<object_api> upstream_;
};

class json_stream_api_impl final : public json_stream_api {
 public:
   boost::asio::awaitable<fcl::http::streaming_response> stream(json_stream_request request) override {
      ...
      co_return fcl::http::streaming_response::from_source(
         fcl::http::streaming_response_options{
            .content_type = "text/plain",
            .body =
               [chunks, index]() mutable -> boost::asio::awaitable<std::optional<fcl::http::body_chunk>> {
...
BOOST_AUTO_TEST_CASE(http_api_special_types_support_streaming_put_and_file_get) {
   ...
   auto put_body = fcl::asio::blocking::run(
      ...
      object->put_object(object_put_request{
         .collection = "cache",
         .key = "chunk.bin",
         .content_type = fcl::http::header<std::string>{.value = "application/octet-stream", .present = true},
         .digest = fcl::http::header<std::string>{.value = "checksum", .present = true},
         .body = fcl::http::body_stream{make_body_reader({payload.substr(0, 2048), payload.substr(2048)})},
      }));
   ...
   auto file = fcl::asio::blocking::run(
      runtime,
   ...
   fcl::asio::blocking::run(runtime, file.save_to(saved));
   BOOST_TEST(std::filesystem::file_size(saved) == 96U * 1024U);

   auto streamed = fcl::asio::blocking::run(
      runtime,
      object->stream_object(object_get_request{.collection = "cache", .key = "chunk.bin"}));
   auto streamed_text = fcl::asio::blocking::run(runtime, streamed.body().async_read_all());
...
BOOST_AUTO_TEST_CASE(http_streamed_response_route_decodes_json_request_body) {
   ...
   const auto response = fcl::asio::blocking::run(runtime, client.async_request(std::move(request_value)));
...
BOOST_AUTO_TEST_CASE(http_streaming_response_from_client_body_is_reserved_when_re_served) {
   ...
   upstream_router.mount(fcl::http::api()
                            ...
                            .bind<object_api>()
                            .build());
   auto upstream_server = fcl::http::server{runtime, server_config{}, std::move(upstream_router)};
   ...
   auto client = fcl::http::client{runtime, parse_base_url("http://127.0.0.1:" + std::to_string(proxy_server.port()))};
   const auto response = fcl::asio::blocking::run(runtime, client.async_get("/objects/cache/chunk.bin/stream"));
...
BOOST_AUTO_TEST_CASE(http_file_response_from_client_body_is_reserved_when_re_served) {
   ...
   auto client = fcl::http::client{runtime, parse_base_url("http://127.0.0.1:" + std::to_string(proxy_server.port()))};
   const auto response = fcl::asio::blocking::run(runtime, client.async_get("/objects/cache/chunk.bin"));
...
BOOST_AUTO_TEST_CASE(http_upload_reader_keeps_small_upload_in_memory) {
   ...
   const auto part = fcl::asio::blocking::run(runtime, reader.async_read());
...
BOOST_AUTO_TEST_CASE(http_upload_reader_enforces_file_and_total_limits) {
   ...
   auto total_limited = upload_reader{make_body_reader({"123", "45"}),
                                      upload_options{.memory_threshold_bytes = 64, .max_file_bytes = 1024,
                                                     .max_total_bytes = 4}};
   BOOST_CHECK_THROW(fcl::asio::blocking::run(runtime, total_limited.async_read()), exceptions::payload_too_large);
