...
replace github.com/libp2p/go-libp2p => ../fixture-deps/go-libp2p

replace github.com/libp2p/go-libp2p-kad-dht => ../fixture-deps/go-libp2p-kad-dht

replace github.com/libp2p/go-libp2p-pubsub => ../fixture-deps/go-libp2p-pubsub
